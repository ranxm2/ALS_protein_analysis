...
```{r heatmap_logistic_plot, fig.width=10, fig.height=10}


# ── Load ───────────────────────────────────────────────────────────────────────
df  <- read.csv(here::here("data","summary_data","Fig3","heat_1yr_wide.csv"))
...
colnames(mat_display_ord)<- paste0("[", seq(-16, -1), ",", seq(-15, 0), ")")
...
ggsave("./results/Fig3B-heatmap_for_pre_ALS_change_2025-10-16.png",
  p_b,
  
  width = 20, height = 18, units = "in", dpi = 300
)
ggsave("./results/Fig3B-heatmap_for_pre_ALS_change_2025-10-16.pdf",
  p_b,
  
  width = 20, height = 18, units = "in"
)
ggsave("./results/Fig3B-heatmap_for_pre_ALS_change_2025-10-16.svg",
  p_b,
...
```{r heatmap_logistic_plot_all, fig.width=20, fig.height=30}
...
# Use run length encoding to find module boundaries
module_lengths <- rle(df_ordered$Module)$lengths
gap_indices <- cumsum(module_lengths)[-length(module_lengths)]  # Remove the last one (no gap after final group)
gap_indices
...
ggsave("./results/Fig3B-heatmap_for_pre_ALS_change_all_2025-10-16.png",
  p_b,
  
  width = 12, height = 20, units = "in", dpi = 300
)
ggsave("./results/Fig3B-heatmap_for_pre_ALS_change_all_2025-10-16.pdf",
  p_b,
  
  width = 20, height = 18, units = "in"
)
ggsave("./results/Fig3B-heatmap_for_pre_ALS_change_all_2025-10-16.svg",
  p_b,
